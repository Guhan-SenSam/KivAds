...
# (list) Permissions
android.permissions = NTERNET, ACCESS_NETWORK_STATE
...
#android.add_gradle_repositories = "com.google.android.gms:play-services-ads:20.3.0"
